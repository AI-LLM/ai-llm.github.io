Note: This case requires strong correlated code comprehension and generation. It is part of a chrome extension to do RAG in browser directly.  function markElements is generated earlier by GPT-4 without need to manual correction. The loop to merge element text by embedding similarity is generated by GPT-4 with mistake and manually corrected. Most of the comments are generated by GPT-4 and not very precise. They can be deleted to compare the model feedback.
